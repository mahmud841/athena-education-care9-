            ...
            {/****************three column ************/}
                <div className="row">
                    ...
                    <div className="col-md-4 col-12">
                        <h5 className="footer-title"><i class="fab fa-pagelines"></i> Target </h5>
                        <p className="pe-4">To Fulfill everybody basic education with quality Teachers </p>
                    </div>

                    
                    <div className="col-md-4 col-12 get-in-touch">
                        <h5 className="footer-title"><i class="fab fa-pagelines"></i> Contact Us </h5>                        
                    ...
                    <div className="col-md-4 col-12 search">
                        <h5 className="footer-title"><i class="fab fa-pagelines"></i>  Serach</h5>                        
                ...
                <div>
                    <p className="text-center mb-2 mt-3">
                        Copyright @2021 <i class="fas fa-copyright"></i> Athena Education Care</p>
                </div>
            </div>
        </div>
    );
